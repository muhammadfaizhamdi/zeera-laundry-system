  ...
  return (
    <div className="flex-1 flex flex-col gap-6 w-full h-full overflow-y-auto pr-2 custom-scrollbar">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white/90 backdrop-blur-xl rounded-[2rem] shadow-sm p-6 md:p-8 border border-slate-100 shrink-0 relative z-50">
        <div><h1 className="text-3xl font-extrabold text-slate-800 mb-1">Transaksi Selesai</h1><p className="text-slate-500 font-medium">Pesanan dalam status Selesai.</p></div>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar pr-2 min-h-0">
          <table className="w-full text-left border-collapse table-fixed">
            ...
            <tbody className="text-sm text-slate-700 divide-y divide-slate-50">
                <tr className="hover:bg-slate-50/50 transition-colors"><td className="py-3.5 pr-4 text-slate-500 font-medium">12 Okt 2026</td><td className="py-3.5 pr-4 font-bold text-slate-800 capitalize">Budi Santoso</td><td className="py-3.5 pr-4 font-black text-[#0f766e]">Rp 45.000</td><td className="py-3.5 pr-4"><span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium bg-blue-50 text-blue-700 border border-blue-100"><span className="w-1.5 h-1.5 rounded-full bg-blue-600"></span>Antrian</span></td><td className="py-3.5 pr-4"><button className="text-[#0F766E] font-bold hover:underline text-sm outline-none">Detail</button></td></tr>
            </tbody>
          </table>
        </div>
      </div>
