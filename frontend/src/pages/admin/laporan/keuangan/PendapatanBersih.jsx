  ...
  return (
    <div className="flex-1 flex flex-col gap-6 w-full h-full overflow-y-auto pr-2 custom-scrollbar">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 shrink-0">
        <div className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-[0_30px_60px_rgba(8,112,184,0.08)] flex flex-col"><span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Total Pemasukan</span><span className="text-3xl font-black text-emerald-600 mt-1">Rp 127.000</span></div>
        <div className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-[0_30px_60px_rgba(8,112,184,0.08)] flex flex-col"><span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Total Pengeluaran</span><span className="text-3xl font-black text-rose-600 mt-1">Rp 120.000</span></div>
        <div className="bg-[#0f766e] p-6 rounded-[2rem] shadow-lg shadow-teal-900/20 flex flex-col"><span className="text-xs font-bold text-teal-100 uppercase tracking-wider">Pendapatan Bersih</span><span className="text-3xl font-black text-white mt-1">Rp 7.000</span></div>
      </div>
          ...
          <table className="w-full text-left border-collapse table-fixed">
            <thead className="sticky top-0 bg-white z-10 shadow-sm border-b border-slate-100">
              <tr className="text-slate-400 font-bold text-xs uppercase tracking-wider">
                <th className="py-4 pr-4 w-[20%]">Tanggal</th><th className="py-4 pr-4 w-[25%]">Keterangan</th><th className="py-4 pr-4 w-[20%]">Kategori</th><th className="py-4 pr-4 w-[20%] text-right">Pemasukan</th><th className="py-4 pr-4 w-[15%] text-right">Pengeluaran</th>
              </tr>
            </thead>
            <tbody className="text-sm text-slate-700 divide-y divide-slate-50">
                <tr className="hover:bg-slate-50/50 transition-colors"><td className="py-3.5 pr-4 text-slate-500 font-medium">12 Okt 2026</td><td className="py-3.5 pr-4 font-bold text-slate-800">Transaksi TRX1710001</td><td className="py-3.5 pr-4 font-semibold text-emerald-600">Pemasukan</td><td className="py-3.5 pr-4 font-black text-right text-emerald-600">Rp 127.000</td><td className="py-3.5 pr-4 font-black text-right text-slate-300">-</td></tr>
                <tr className="hover:bg-slate-50/50 transition-colors"><td className="py-3.5 pr-4 text-slate-500 font-medium">12 Okt 2026</td><td className="py-3.5 pr-4 font-bold text-slate-800">Beli Rinso</td><td className="py-3.5 pr-4 font-semibold text-rose-600">Bahan Baku</td><td className="py-3.5 pr-4 font-black text-right text-slate-300">-</td><td className="py-3.5 pr-4 font-black text-right text-rose-600">Rp 120.000</td></tr>
            </tbody>
          </table>
        </div>
      </div>
